...
class SpectralFusionDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, img_path: str, mask_path: str, *args, data_name='CAVE',
                 ...
                 load_mode: str='mat',
                 rgb_input: bool=True, rgb_label: bool=True,
                 rgb_encode: bool=False, **kwargs) -> None:
...
class RGBPreTrainDataloader(torch.utils.data.Dataset):
...
class RGBPreTrainEvalDataloader(RGBPreTrainDataloader):
...
class RGBTrainDataloader(torch.utils.data.Dataset):
