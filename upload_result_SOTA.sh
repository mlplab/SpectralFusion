...
for dataset in $datasets; do
    ...
    for concat in $concats; do
        for base_model_name in $model_names; do
            ...
            rm -rf ../SCI_result/$dataset\_sota/$upload_model_name/$upload_model_name\_upload
            ...
            skicka upload ../SCI_result/$dataset\_$start_time/$upload_model_name/$upload_model_name\_upload/ 2021/SpectralFusion/$dataset/ckpt_$start_time/SOTA/$model_name
