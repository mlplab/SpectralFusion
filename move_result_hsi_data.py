...
mat_img_names = {'CAVE': 'stuffed_toys_ms_00000', 
                 'Harvard': 'imgf3_00003'}
for img_id in range(12):
    for data_name in data_names:
        if data_name == 'Harvard': break
        ckpt_path = '../SCI_result'
        result_path = f'../SCI_result/{data_name}_1004'
        move_path = f'../upload_1004/{data_name}/propose_no_rgb_branch'
        ...
        for block_num in block_nums:
            for concat in concat_flag:
                ...
                output_data = np.clip(mat_data, 0., 1.)[:, :, (26, 16, 9)]
